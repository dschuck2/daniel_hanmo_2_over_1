...
\newcommand{\li}{\item[~]}
\newcommand{\bidsection}[1]{\newpage \section{\texorpdfstring{#1}{}}}
...
\bidsection{\cl{1}}
    ...
    \ul {
        ...
        \ul {
            ...
            \ul {
                \li \cl3 - transfer to \di{3} for signoff or \cl{} slam try.  After \di3 (passable):
                \ul {
...
\bidsection{\di{1}}
    ...
    \ul {
        ...
        \ul {
            ...
            \li \sp2 - Natural jump shift in \sp{} or \cl{}, or single suitor
            \ul {
                \li 2NT - blackout
...
\bidsection{\he{1}}
    ...
    \ul {
        ...
        \ul {
            \li \sp2 - arbitrary splinter, no help-suit.  Relay to 2NT
...
\bidsection{1NT [14(+)-17]}
    ...
    The full structure is as follows:
    \ul{
        \li \cl2 - stayman (not 5-5 in majors) or slammish with \textit{excactly} 5 cards in a minor
        \ul{
...
\bidsection{2\di{}/\he{}\sp{}}
    ...
    Note that point ranges are rough guidance. \hhand{KT9, x, QJT9xxx, xxx} is worth much more than [6] opposite a \sp2 response, while \hhand{xx, QJ, KJxxxx, QJx} is worth less than the [9] advertised.  New suits after OGUST are 5+, natural and forcing.
    
\bidsection{2NT [20-21]}
...
\bidsection{3\cl{}/\di{}/\he{}/\sp{}}

    Unlike 2-level preempts, 3-level preempts are mostly non-constructive.  They almost always show a minimum 7-card suis; the exceptions occur 3rd seat at favorable vulnerability or \cl3 (since \cl2 is not preemptive). \n

\section{3NT - Gambling}

    3NT shows a 7-card (or better) minor headed by AKQ (or better).  In 1st/2nd seat, opener may have no more than an outside doubleton Q.  In 3rd/4th seat, opener promises \textit{exactly} one outside stopper.\n

\section{\texorpdfstring{4\cl{}/\di{}/\he{}/\sp{} - Preempts and NAMYATS}{}}
