...
\section{Suit-based Interference - 4th Seat} \label{3:3}
    ...
    The auction (1M)-p-(2M)-X is special, since X can be highly flexible.  The opponents have a known major fit, and 4th seat is short.  Thus, it is more important to find a good partial, rather than game.  Games can be bid directly by the massive overcaller or a good advancer.  For partial-hunting, 2NT is employed as `scrambling', asking the partnership to bid up 4-card suits to find a fit, naturally implying 3z is a 5-card suit.

    \ul {
        \li (\sp1)-p-(\sp2)-X
        \ul {
            \li 2NT - scrambling, bid 4-card suits up the line (not denying 4\he{}s).  Promises 2 4-card suits
            \li \cl3 - 5+\cl{}s
            \li \di3 - 5+\di{}s
            \li \he3 - 4+\he{}s (could be 5)
        }
    }
...
\section{Slam Interference} \label{3:7}
    ...
    If opponents interfere with a keycard auction, 1430 step responses are used DIPO/RIPO style:

    \ul{
        \li \sp1-2NT-\sp3-4NT-\he5-
        \ul {
            \li X - 0/3 keycards
            \li pass - 1/4 keycards
            \li Step 1 - 2/5 without Q
            \li Step 2 - 2/5 with Q
        }
    }
