...
\section{Suit-based Overcalls - 2nd Seat} \label{4:2}
    ...
    Suit overcalls promise a 5-card suit (or better) with [(7+)-17] at the 1-level and [(10+)-17] at the 2-level.  With [18+], first X, then bid suit.  Some examples:
    \ul {
        \li (\cl1)
        \ul {
            \li X - [11+], no suit (not promising \di{}) or [18+],.  Usually 2-\cl{}s and 4-4 in majors
            \li 1z - [(7+)-17] 5+ card suit with some quality
        }
        \li (\he1)
        \ul {
            \li X - [11+] for takeout, 3-4\sp{}s.  may have a 5-card minor.
            \li \sp1 - [(7+)-17] 5+ cards, some quality
            \li 2z - [(10+)-17] 5+ cards, good quality
        }
    }

    After a double, advancer must respond, even with no points.  A NT bid shows points and a stopper, lowest suits show [0-7], single jumps show [8-11], and a cue shows [11+].  Double jumps below game preemptive, and jumps to game show [12+] with a 5-card (or better) suit:
    ...
    \ul {
        ...
        \ul {
            ...
            \li 1NT - [7-10] \cl{} stopper; no majors
    ...
    Since Equal Level Conversion (ELC) is on, X may be short in clubs and correct to diamonds (typically 5-card suit).  Any other bids (aside from raises) show an [18+] hand with that suit.  With a strong raise, balanced without stopper, or any other awkward hand, cue:

    \ul {
        \li (\he1)-X-(p)-\cl2-(p)
        \ul {
            \li \di2 - [11-17] 4+\di{}s, typically 5.
            \li \he2 - [18+] balanced without stopper, GF strength, or strong club raise
            \li \sp2 - [18-21] 5+\sp{}s
            \li 2NT - [19-21] balanced with stopper
            \li \cl3 - [11-17] 4+\cl{}s, preemptive
            \li \di3 - [18-21] 5+\di{}s
        }
        \li (\he1)-X-(p)-\sp2-(p)
        \ul {
            \li suit - [18+] 5+ cards.
            \li \he3 - [18+] awkward GF
            \li \sp3 - [(14+)-16] 4\sp{}s
            \li \sp4 - [17+] 4+\sp{}s
        }
    }
...
\section{Suit-based Overcalls - 4th Seat} \label{4:3}
    ...
    4th seat overcalling is nearly identical to 2nd seat overcalling.  However, since partner has denied strength (by not overcalling), overcalls promise better suits and more strength.  [(8+)-17] for 1-level overcalls, and [12-17] for 2-level, with good suit quality. \n
    ...
    After a 4th seat X, 2nd seat's bid of the opponents (quasi) suits are \textit{natural} and to play, showing no support for either of overcaller's suits.
\newpage
\section{NT Overcalls and Defense} \label{4:4}
    ...
    In the balancing seat of a strong (1NT)-p-(p), only Landy is used (all other naturals), with X for clubs.  This allows 2nd seat to pass X for penalty when holding a strong hand:
    \ul {
        \li X - [9+] 5+\cl{}s
        \li \cl2 - [9+] majors
        \li 2z - [9+] 5+\di{}s
