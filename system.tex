...
\subsection{Takeout Doubles}
    ...
    When 3rd seat interjects, X shows 4-4 in the other suits (or minors after 1M-2M). Since there is no need to respond, weak hands are passed and the lowest-level suits show [8-11].  Jumps show [6-9], a 5-card suit, and preemptive value.  Example:
